...
/* Puedes añadir más estilos para el contenido principal si es necesario */
/* Por ejemplo, añadir padding al router-view para que el contenido no quede pegado a la barra */
/*
